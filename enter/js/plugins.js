...
(function ($) {
  ...
  $.flexslider.defaults = {
    ...
    slideshowSpeed: 1500,           //Integer: Set the speed of the slideshow cycling, in milliseconds
    ...
    $.fn.lightbox = function (options) {
        ...
        plugin.selector = "lightbox-"+Math.random().toString().replace('.','');
            ...
            loadImage: function () {
                ...
                $("p", plugin.lightbox).remove();
                plugin.lightbox.fadeIn('fast').append('<span class="lightbox-loading"></span>');

                var img = $('<img src="' + $(plugin.current).attr('href') + '" draggable="false"><p style=" position: fixed; bottom: 0; padding: 10px 20px; font-size: 14px; color:  white; text-align:  center; display:  block; width: 100%; background-color: #00000091; margin: 0px;"><b>' + $(plugin.current).attr('title') + '</b><br>' + $(plugin.current).attr('dist') + '<br>' + $(plugin.current).attr('howfar') + ' <span style=" display:  block; text-align:  right; font-style:  italic; padding-right: 20px; text-shadow: 1px 1px 9px white;"><a style="color:white;" href="' + $(plugin.current).attr('cont') + '">Book Now...</a></span></p>');
